    ...
    <div class="sidebar-content">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                @can('manage_user' || 'manage_role' || 'manage_permission')
                    <div
                        ...
                        <div class="submenu-content">
                            ...
                            @can('manage_user')
                                <a href="{{ url('users') }}"
                                    class="menu-item {{ $segment1 == 'users' || $segment1 == 'user' ? 'active' : '' }}">{{ __('Users') }}</a>
                            @endcan
                            <!-- only those have manage_role permission will get access -->
                            @can('manage_roles')
                                <a href="{{ url('roles') }}"
                                    class="menu-item {{ $segment1 == 'roles' || $segment1 == 'role' ? 'active' : '' }}">{{ __('Roles') }}</a>
                            @endcan
                ...
                @endcan
                @can('manage_content')
                    <div class="nav-lavel">{{ __('Content Management') }} </div>
                    <div class="nav-item">
                    ...
                    <div class="nav-item has-sub">
                        ...
                        <div class="submenu-content">
                            ...
                            <a href="#" class="menu-item">{{ __('Shelter') }}</a>
                            <a href="#" class="menu-item">{{ __('History') }}</a>
                            <a href="#" class="menu-item">{{ __('Gallery') }}</a>
                        </div>
                    </div>
                    <div class="nav-item">
                        <a href="#"><i class="ik ik-activity"></i><span>{{ __('Treks') }}</span></a>
                    </div>
                    <div class="nav-item {{ $segment1 == 'blogs' || $segment1 == 'blog' ? 'active open' : '' }}">
                        <a href="{{ url('blogs') }}"><i class="ik ik-file-text"></i><span>{{ __('Blogs') }}</span></a>
                    </div>
                    <div class="nav-item {{ $segment1 == 'contacts' || $segment1 == 'contact' ? 'active open' : '' }}">
                        <a href="{{ url('contacts') }}"><i class="ik ik-mail"></i><span>{{ __('Contacts') }}</span></a>
                    </div>
                    <div class="nav-item">
                        <a href="#"><i class="ik ik-image"></i><span>{{ __('Cover Thumbnail') }}</span></a>
                    </div>
                @endcan
                <hr />
